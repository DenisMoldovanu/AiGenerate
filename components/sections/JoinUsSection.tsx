        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 lg:gap-6 mb-12">
          <div className="flex flex-col gap-2">
            <span className="text-sm font-medium text-black">
              <span className="text-[#780000]">&gt;</span> Let&apos;s Connect
            </span>
            <h2 className="text-[32px] lg:text-[48px] font-extrabold leading-[1.17] text-black">
              Join Us
            </h2>
          </div>
          <span className="text-sm font-medium text-gray-600 border-b-2 border-[#780000] pb-0.5 shrink-0 self-start lg:self-auto">
            Generate Growth
          </span>
        </div>

        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-stretch">
          <div className="flex-1 rounded-[24px] bg-[#f7f4f4] p-6 lg:p-8 flex flex-col">
            ...
            <Link
              href="#"
              className="inline-flex items-center justify-center gap-2 rounded-[22px] border-2 border-[#780000] px-5 py-2.5 text-base font-medium text-[#780000] hover:bg-[#780000] hover:text-white transition-colors w-fit"
            >
          ...
          <div className="flex-1 rounded-[24px] overflow-hidden shrink-0">
            <Image
          ...
          <div className="flex-1 rounded-[24px] bg-[#780000] p-6 lg:p-8 flex flex-col">
            ...
            <Link
              href="#"
              className="inline-flex items-center justify-center gap-2 rounded-[22px] bg-white px-5 py-2.5 text-base font-medium text-[#780000] hover:bg-gray-100 transition-colors w-fit"
            >
